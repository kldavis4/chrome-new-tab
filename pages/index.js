    ...
    return (
        <Layout>
            <div className="invisible">
                <form><input type="text" ref={textInput}/></form>
            </div>
                    ...
                    <div
                        ...
                        {bookmarksList.map((bookmark) => (
                            <div key={bookmark.node.id} className="group relative">
                                <Link href={bookmark.node.data.url}><a>
                                    ...
                                    <div className="mt-4 flex justify-between">
                                        <div>
                                            <h3 className="text-lg text-gray-700 text-center">
                                                ({bookmark.node.data.keyBinding}) {bookmark.node.data.title}
                                            </h3>
                                        </div>
                                    </div>
                                </a></Link>
                    ...
                    >
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            <div
                                ...
                                <div
                                    className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t bg-slate-200">
                                    <h3 className="text-3xl">
                                        navigating to <span
                                        className="font-semibold">{codeToBookmark[selectedSite].title}</span>
                                    </h3>
                                </div>
